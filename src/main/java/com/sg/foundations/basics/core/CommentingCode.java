...
public class CommentingCode {
    public static void main(String[] args) {
        ...
        System.out.println("Normall code is compiled and runs ...");
        ...
        /* This is an example of a multi-line comment, which is useful if
           you want to comment out multiples lines of code quickly.
           Console.WriteLine("Java ignores everything indside the comment markers.");
        */   
    }
